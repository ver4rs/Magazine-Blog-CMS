...
// configuration
 $appid = '198337553623718';
 $appsecret = '061ead71b8b1e7e7753fda4034816efd';
 $pageId = 'NewInfoWorld';  // stranka nazov
 $msg =  'Krása čo viac dodať...'; //'Pozri si toto fotky.'; // popis k clanku nieco fb
 $title = 'mobilai.cz';  // titul hore
 ...
 $action_name = 'ver4rs'; //'ver4rs';
 $action_link = 'http://www.mobilai.cz'; //$url_Adresa; //'http://www.vybertvar.6f.sk'; // titul dole
